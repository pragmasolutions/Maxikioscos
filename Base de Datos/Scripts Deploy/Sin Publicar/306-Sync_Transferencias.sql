...
/****** Object:  StoredProcedure [dbo].[Sync_Transferencias]    Script Date: 08/09/2014 15:50:12 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Sync_Transferencias]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Sync_Transferencias]
GO
