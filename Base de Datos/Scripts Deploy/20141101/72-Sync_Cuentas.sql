...
BEGIN
	...
	(
	   ...
	   MotivoCorreccionPorDefecto int,
	   Desincronizado bit, 
	...
	WITH CuentasCTE (CuentaId, Identifier, Titular, MargenImporteFactura, 
		  AplicarPercepcionIVADesde, PorcentajePercepcionIVA, MotivoCorreccionPorDefecto,
	...
	AS (
		...
		FROM       OPENXML (@idoc, '/Exportacion/Cuentas/Cuenta',1) 
				 WITH (CuentaId INT	'MarcaId', 
					   ...
					   MotivoCorreccionPorDefecto int 'MotivoCorreccionPorDefecto',
	 ...
	 SET Titular = CTE.Titular, 
		...
		MotivoCorreccionPorDefecto = CTE.MotivoCorreccionPorDefecto,
	...
	WHERE (@SobreescribirLocal = 1 OR
	 ...
	 INSERT INTO Cuenta (Identifier, Titular, MargenImporteFactura, AplicarPercepcionIVADesde, 
		PorcentajePercepcionIVA, MotivoCorreccionPorDefecto, Desincronizado,FechaUltimaModificacion, Eliminado)
	 SELECT Identifier, 
			Titular,
			MargenImporteFactura,
			AplicarPercepcionIVADesde,
			PorcentajePercepcionIVA,
			MotivoCorreccionPorDefecto,
			Desincronizado,
