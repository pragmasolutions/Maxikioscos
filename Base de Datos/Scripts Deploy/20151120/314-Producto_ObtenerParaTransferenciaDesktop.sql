/****** Object:  StoredProcedure [dbo].[Producto_ObtenerProductoPorCodigo]    Script Date: 06/02/2015 18:20:50 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Producto_ObtenerParaTransferenciaDesktop]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Producto_ObtenerParaTransferenciaDesktop]
GO
