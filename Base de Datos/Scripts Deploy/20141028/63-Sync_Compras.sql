/****** Object:  StoredProcedure [dbo].[Sync_Compras]    Script Date: 10/11/2014 17:32:09 ******/
...
BEGIN
	...
	WITH CompraCTE (CompraId, Identifier, Fecha, Numero, Desincronizado, FechaUltimaModificacion,
	   Eliminado, PercepcionIVA,PercepcionDGR, FacturaIdentifier, CuentaIdentifier, MaxiKioscoIdentifier)
	AS (
		SELECT    *
