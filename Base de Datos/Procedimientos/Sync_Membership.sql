/****** Object:  StoredProcedure [dbo].[Sync_Membership]    Script Date: 08/09/2014 15:50:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Sync_Membership]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Sync_Membership]
GO

CREATE PROCEDURE [dbo].[Sync_Membership] 
	@XML XML,
