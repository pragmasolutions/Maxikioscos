...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Producto_ParaTransferencia]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Producto_ParaTransferencia]
GO
