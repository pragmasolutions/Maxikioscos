/****** Object:  StoredProcedure [dbo].[Sync_RetirosPersonalesProductos]    Script Date: 01/19/2015 17:48:59 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Sync_RetirosPersonalesProductos]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Sync_RetirosPersonalesProductos]
GO
