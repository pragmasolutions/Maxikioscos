...
/****** Object:  StoredProcedure [dbo].[Sync_Usuarios]    Script Date: 08/09/2014 15:51:34 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Sync_Usuarios]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Sync_Usuarios]
GO


CREATE PROCEDURE [dbo].[Sync_Usuarios] 
	@XML XML,
