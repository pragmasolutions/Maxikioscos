/****** Object:  StoredProcedure [dbo].[Sync_Excepciones]    Script Date: 01/17/2015 20:12:50 ******/
...
BEGIN
	...
	;
	 ...
	 WHERE CTE.Identifier NOT IN (SELECT Identifier FROM Excepcion)
		AND (SELECT TOP 1 CierreCajaId FROM CierreCaja WHERE Identifier = CTE.CierreCajaIdentifier) IS NOT NULL
