/****** Object:  StoredProcedure [dbo].[Sync_ProductoPromociones]    Script Date: 08/09/2014 15:50:19 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Sync_ProductoPromociones]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Sync_ProductoPromociones]
GO
