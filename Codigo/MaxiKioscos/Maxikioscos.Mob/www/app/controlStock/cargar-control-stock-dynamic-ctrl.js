(function() {
    ...
    angular.module('maxikioscosApp').controller('CargarControlStockDynamicCtrl', ['$scope', '$q', '$rootScope', '$state', '$timeout', '$cordovaBarcodeScanner', '$ionicScrollDelegate', '$ionicPosition', 'controlStockApi',
