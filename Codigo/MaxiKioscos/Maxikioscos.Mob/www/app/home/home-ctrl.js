(function() {
    ...
    homeCtrl.$inject = ['$scope', 'maxikioscosService', 'httpService', 'SERVICE_CONSTANTS', 'controlStockApi', '$ionicPopup', 'localStorageService', '$ionicHistory'];

    function homeCtrl($scope, maxikioscosService, httpService, SERVICE_CONSTANTS, controlStockApi, $ionicPopup, localStorageService, $ionicHistory) {
        var vm = this;
