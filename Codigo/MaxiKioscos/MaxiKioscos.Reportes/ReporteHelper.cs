...
namespace MaxiKioscos.Reportes
{
    public class ReporteHelper
    {
        ...
        public static byte[] ReporteRenderizar(ReporteTipoEnum tipo, string dataSourceName, object dataSource, string reportePathCompleto, string[] columnasMostrar, out string mimeType)
        {
            return ReporteRenderizar(tipo, dataSourceName, dataSource, reportePathCompleto, columnasMostrar, new Dictionary<string, string>(), out mimeType);
        }

        public static byte[] ReporteRenderizar(ReporteTipoEnum tipo, string dataSourceName, object dataSource, string reportePathCompleto, IDictionary<string, string> parametros, out string mimeType)
        {
            return ReporteRenderizar(tipo, dataSourceName, dataSource, reportePathCompleto, new string[0], parametros, out mimeType);
        }
        ...
        public static string OutputFormat(ReporteTipoEnum tipo)
        {
