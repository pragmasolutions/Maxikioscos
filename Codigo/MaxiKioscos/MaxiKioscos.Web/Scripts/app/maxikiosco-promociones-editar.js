var productos = function () {
    var $modal = $("#ProductosModal"),
        ...
        init = function () {
            ...
            $('.btn-agregar-promocion', $modal).click(agregarPromocion);
        ...
        parseControls = function () {
            ...
            var $btnEliminarPromocion = $('.btn-eliminar-promocion', $modal);
            parseConfirmEliminarCodigo($btnEliminarCodigo);
            parseConfirmEliminarCosto($btnEliminarCosto);
            parseConfirmEliminarPromocion($btnEliminarPromocion);
        ...
        agregarPromocion = function () {
            ...
            $.ajax({
                ...
                var $row = $(row);
                $modalContent.find('#PromocionesList').append($row);
                var $btnEliminarPromocion = $row.find('.btn-eliminar-promocion');
                parseConfirmEliminarPromocion($btnEliminarPromocion);

                controles.parse('#PromocionesList');
        ...
        eliminarPromocion = function (btnDelete) {
            $(btnDelete)
                .closest('tr')
                .remove();
        },
        ...
        parseConfirmEliminarPromocion = function (element) {

            $(element).confirm({
                text: "¿Esta seguro que desea eliminar el producto?",
                title: "Eliminar Producto",
                confirm: eliminarPromocion,
                confirmButton: "Aceptar",
                cancelButton: "Cancelar"
            });
        },
        ...
        formProductosSubmit = function () {
            ...
            promosCount = $('#PromocionesList tr').length;
            if (promosCount == 0) {
                var $tab = $('a[href="#TabProductos"]');
                $tab.tab('show');
                return false;
            }
