...
namespace MaxiKioscos.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IMaxiKioscosUow uow,IAuthService authService)
        {
            Uow = uow;
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            ModelState.AddModelError("", "El usuario o en password es incorrecto.");
            return View(model);
        }
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (usuario == null)
                {
                    ...
                    Uow.Usuarios.Agregar(new Usuario() { NombreUsuario = model.UserName });
                    Uow.Commit();
