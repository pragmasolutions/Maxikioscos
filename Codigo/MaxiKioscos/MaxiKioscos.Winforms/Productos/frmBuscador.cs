...
namespace MaxiKioscos.Winforms.Productos
{
    public partial class frmBuscador : Form
    {
        ...
        public ProductoHorario ProductoSeleccionado { get; set; }
        ...
        public delegate void CambioEventHandler(ProductoHorario productoHorario);
        ...
        public frmBuscador(string texto, List<ProductoHorario> productos, bool esVenta, ProductoCriterioBusqueda criterio)
        {
            InitializeComponent();
    ...
    public enum ProductoCriterioBusqueda
    {
        Codigo,
        Descripcion,
        Marca
