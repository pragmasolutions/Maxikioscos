...
BEGIN
	...
	(
	   ...
	   LimiteMaximoVentaEnBlanco money NULL,
	   Desincronizado bit, 
	...
	WITH CuentasCTE (CuentaId, Identifier, Titular, MargenImporteFactura, 
	      ...
	      IntervaloSincronizacion, LimiteMaximoRetiroPersonal, LimiteMaximoVentaEnBlanco,
	...
	AS (
		...
		FROM       OPENXML (@idoc, '/Exportacion/Cuentas/Cuenta',1) 
				 WITH (CuentaId INT	'MarcaId', 
					   ...
					   LimiteMaximoVentaEnBlanco money 'LimiteMaximoVentaEnBlanco',
	 ...
	 SET Titular = CTE.Titular, 
	    ...
	    LimiteMaximoVentaEnBlanco = CTE.LimiteMaximoVentaEnBlanco,
