ALTER PROCEDURE [dbo].[Sync_Ventas] 
	@XML XML,
...
BEGIN
	...
	WITH VentaCTE (VentaId, Identifier, CostoTotal, ImporteTotal, FechaVenta, Facturada, 
					NroComprobante, Eliminado, Desincronizado, FechaUltimaModificacion, CierreCajaIdentifier)
	AS (
		SELECT    *
		FROM     OPENXML (@idoc, '/Exportacion/Ventas/V/CC',2) 
				 WITH (VentaId int '../VentaId',
						...
						NroComprobante varchar(15) '../NroComprobante',
