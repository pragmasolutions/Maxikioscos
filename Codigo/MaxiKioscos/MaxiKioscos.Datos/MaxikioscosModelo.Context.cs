...
namespace MaxiKioscos.Entidades
{
    ...
    public partial class MaxiKioscosEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> ExportacionNuevoXmlPrincipal(Nullable<int> usuarioId)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("UsuarioId", usuarioId) :
                new ObjectParameter("UsuarioId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("ExportacionNuevoXmlPrincipal", usuarioIdParameter);
        }
        ...
        public virtual ObjectResult<RptVentasNegativasPorTicketRow> RptVentasNegativasPorTicket(Nullable<int> usuarioId, Nullable<System.DateTime> desde, Nullable<System.DateTime> hasta)
        {
            var usuarioIdParameter = usuarioId.HasValue ?
                new ObjectParameter("UsuarioId", usuarioId) :
                new ObjectParameter("UsuarioId", typeof(int));
        ...
        public virtual ObjectResult<RptVentasPorProveedor> RptVentasPorProveedor(Nullable<System.DateTime> desde, Nullable<System.DateTime> hasta, Nullable<int> rubroId, Nullable<int> maxikioscoId, Nullable<int> proveedorId, Nullable<int> cuentaId)
        {
            var desdeParameter = desde.HasValue ?
                new ObjectParameter("Desde", desde) :
                new ObjectParameter("Desde", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<RptVentasPorProveedor>("RptVentasPorProveedor", desdeParameter, hastaParameter, rubroIdParameter, maxikioscoIdParameter, proveedorIdParameter, cuentaIdParameter);
        }
    
        public virtual ObjectResult<RptVentasPorProveedorTotalGeneral> RptVentasPorProveedorTotalGeneral(Nullable<System.DateTime> desde, Nullable<System.DateTime> hasta, Nullable<int> rubroId, Nullable<int> proveedorId, Nullable<int> cuentaId)
        {
            var desdeParameter = desde.HasValue ?
                new ObjectParameter("Desde", desde) :
                new ObjectParameter("Desde", typeof(System.DateTime));
        ...
        public virtual ObjectResult<RptVentaPorProducto> RptVentasPorProductoCompleto(Nullable<System.DateTime> desde, Nullable<System.DateTime> hasta, Nullable<int> rubroId, Nullable<int> maxikioscoId, Nullable<int> cuentaId)
        {
            var desdeParameter = desde.HasValue ?
                new ObjectParameter("Desde", desde) :
                new ObjectParameter("Desde", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<RptVentaPorProducto>("RptVentasPorProductoCompleto", desdeParameter, hastaParameter, rubroIdParameter, maxikioscoIdParameter, cuentaIdParameter);
        }
    }
}
